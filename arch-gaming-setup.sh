...
main_installation() {
    ...
    lib32-vulkan-icd-loader obs-studio mangohud lib32-mangohud goverlay gamescope solaar bluez bluez-utils pipewire pipewire-pulse pipewire-alsa linux-headers xwaylandvideobridge

    echo "Installing AUR packages with yay..."
    yay -S --noconfirm \
        vkbasalt lib32-vkbasalt proton-ge-custom-bin xone-dkms-git dxvk-bin vesktop-bin 
